...
import math as mt
root = Tk()
root.title("Calculator by Sabareeshwaran.S")
...
def button_CONV():
    ...
    conv_window.grid(row=0, column=0, columnspan=3, padx=5, pady=5)
    e = conv_window
    e.insert(0, text1)
    ...
    button_len = Button(root_CONV, text="m to ft",  width=8, height=1)
    button_len.grid(row=1, column=0)
    button_len.bind('<Button-1>', button_click1)
    button_weight = Button(root_CONV, text="kgs to lbs",  width=8, height=1)
    button_weight.grid(row=1, column=1)
    button_weight.bind('<Button-1>', button_click1)
    button_area = Button(root_CONV, text="Acre to m\u00b2",  width=8, height=1)
    button_area.grid(row=1, column=2)
    button_area.bind('<Button-1>', button_click1)
    button_pressure = Button(root_CONV, text="atm to kPa",  width=12, height=1)
    button_pressure.grid(row=2, column=0)
    button_pressure.bind('<Button-1>', button_click1)
    button_vol = Button(root_CONV, text="gal(US) to Ltr", width=12, height=1)
    button_vol.grid(row=2, column=1)
    button_vol.bind('<Button-1>', button_click1)
    button_temp = Button(root_CONV, text="˚C to ˚F", width=12, height=1)
    button_temp.grid(row=2, column=2)
    button_temp.bind('<Button-1>', button_click1)
    button_convert = Button(root_CONV, text="convert", width=22, height=1, activebackground='light green', fg="red", command = convert)
    button_convert.grid(row=3, column=1, columnspan=2)
    button_reverse = Button(root_CONV, text="Reverse", width=12, height=1, activebackground='purple', fg="red",
                            command= reverse)
...
for i in range(2, 5):
    for j in range(3):
        btn = Button(root, text = str(temp), font=("Ariel", 15, "bold"), width=12, height=1, highlightbackground='light blue', activeforeground='red', activebackground='white')
        btn.grid(row=i, column=j)
        btn.bind('<Button-1>', button_click)
        temp += 1

button_0 = Button(root, text="0", font=("Ariel", 15, "bold"),  width=12, height=1, highlightbackground='light blue')
button_0.bind('<Button-1>', button_click)
button_equal = Button(root, text="=", fg="blue", font=("Ariel", 15, "bold"),highlightbackground='light green',  width=12, height=1)
button_equal.bind('<Button-1>', button_click)
button_clear = Button(root, text="CE", fg="red", font=("Ariel", 15, "bold"), highlightbackground='light yellow',  width=12, height=1, command=button_clear1)
button_pi = Button(root, text="π", font=("Ariel", 15, "bold"),  width=12, height=1, highlightbackground='light blue')
button_pi.bind('<Button-1>', button_click)
button_bkspc = Button(root, text="C", fg="red", font=("Ariel", 15, "bold"),  width=12, height=1, command= bkspc)

button_add = Button(root, text="+", fg="green", highlightbackground='pink', font=("Ariel", 15, "bold"),  width=12, height=1)
button_add.bind('<Button-1>', button_click)
button_sub = Button(root, text="-", fg="brown", highlightbackground='pink', font=("Ariel", 15, "bold"),  width=12, height=1)
button_sub.bind('<Button-1>', button_click)
button_mul = Button(root, text="*", fg="dark green", highlightbackground='pink', font=("Ariel", 15, "bold"),  width=12, height=1)
button_mul.bind('<Button-1>', button_click)
button_div = Button(root, text=" /", fg="purple", highlightbackground='pink', font=("Ariel", 15, "bold"),  width=12, height=1)
button_div.bind('<Button-1>', button_click)
button_sqrt = Button(root, text="√(", fg="red", font=("Ariel", 15, "bold"),  width=12, height=1)
button_sqrt.bind('<Button-1>', button_click)

button_Ans = Button(root, text="Last Output", highlightbackground='yellow', fg="dark green", font=("Ariel", 15, "bold"),  width=12, height=1, command= button_Ans)
button_last_input = Button(root, text="Last Input", highlightbackground='yellow', fg="dark green", font=("Ariel", 15, "bold"),  width=12, height=1, command= button_last_input)
button_CONV = Button(root, text="CONV", fg="grey", font=("Ariel", 15, "bold"),  width=12, height=1, command=button_CONV)
button_x2 = Button(root, text="x\u00b2", fg="grey", font=("Ariel", 15, "bold"),  width=12, height=1, command=button_x2)
button_xn = Button(root, text=f"x{chr(710)}n", fg="grey", font=("Ariel", 15, "bold"),  width=12, height=1, command=button_xn)
button_left_brace = Button(root, text="(", fg="red", font=("Ariel", 15, "bold"),  width=12, height=1)
button_left_brace.bind('<Button-1>', button_click)
button_right_brace = Button(root, text=")", fg="red", font=("Ariel", 15, "bold"),  width=12, height=1)
button_right_brace.bind('<Button-1>', button_click)
button_sin = Button(root, text="sin(", fg="brown", font=("Ariel", 15, "bold"),  width=12, height=1)
button_sin.bind('<Button-1>', button_click)
button_cos = Button(root, text="cos(", fg="brown", font=("Ariel", 15, "bold"),  width=12, height=1)
button_cos.bind('<Button-1>', button_click)
button_tan = Button(root, text="tan(", fg="brown", font=("Ariel", 15, "bold"),  width=12, height=1)
button_tan.bind('<Button-1>', button_click)
button_dms = Button(root, text="˚'\"", fg="brown", font=("Ariel", 15, "bold"),  width=12, height=1, command= button_dms)
button_dot = Button(root, text=".", fg="brown", font=("Ariel", 15, "bold"),  width=12, height=1)
button_dot.bind('<Button-1>', button_click)
button_xinv = Button(root, text=f"x{chr(175)}\u00b9", font=("Ariel", 15, "bold"),  width=12, height=1, command=button_xinv)
...
credit = Menu(menubar, font = fontMenu)
credit.add_command(label='Created by :-')
credit.add_command(label='SABAREESHWARAN S')
menubar.add_cascade(label='Credits', menu=credit)
# T = Label(root,  text= label_text, width = 10, font = ('ariel', 5), bg = 'powder blue', fg = 'black')
# T.grid(row=0, column=5, padx=0, pady=2)
